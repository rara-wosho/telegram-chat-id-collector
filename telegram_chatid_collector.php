...
<head>
  ...
  <style>
    ...
    * {
    ...
    tbody tr:hover {
      background: rgba(74, 240, 160, 0.03);
    }
  ...
  <div class="container">
    ...
    <div class="card">
      ...
      <div class="how-to">
        ...
        1. Save this file as <strong>telegram-chat-id-collector.php</strong><br>
        ...
        4. Open browser: <strong>http://localhost:8080/telegram-chat-id-collector.php</strong><br>
